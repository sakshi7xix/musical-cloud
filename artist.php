...
<body>
	...
	<p>	
		<h1> Artists Used in the Database: </h1>
		<table>
			<thead>
				<tr>
					<th>Artist's Name</th>
			...
			<tbody>
				 <?php
					$selectquery1 = "SELECT * FROM Artist";
					...
					?>
						...
						<tr>
							<td><?php echo res2['artist_name']; ?> </td>
							<td><?php echo res2['artist_country']; ?></td>
						</tr>
				...
				*/
					...
					<tr>
						...
						<td><?php echo $row['artist_country']; ?></td>
					</tr>
