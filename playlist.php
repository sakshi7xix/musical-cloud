		...
		<div class="container-fluid">
			...
			<div class="container">
				<ul class="playlist-filter controls">
					...
					<li class="control"><a href="upload.php">upload Songs</a></li>
				</ul>
			</div>
			...
			<div class="row playlist-area">
				<!-- <div class="mix col-lg-3 col-md-4 col-sm-6 genres">
					<div class="playlist-item">
						...
						<h5><a href="LiveConcerts.php">Live Concerts</a></h5>
					</div>
				</div> -->
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 labels">
					<div class="playlist-item">
						...
						<h5><a href="Oldies.php">Oldies</a></h5>
					</div>
				</div>
				<div class="mix col-lg-3 col-md-4 col-sm-6 genres">
					<div class="playlist-item">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 artists">
					<div class="playlist-item">
						...
						<h5><a href="Kannada.php">Kannada</h5>
					</div>
				</div>
				<div class="mix col-lg-3 col-md-4 col-sm-6 movies">
					<div class="playlist-item">
						<img src="img/playlist/7.jpg" alt="">
						<h5><a href="rock.php">Rock</h5>
					</div>
				</div>
				<!-- <div class="mix col-lg-3 col-md-4 col-sm-6 labels">
					<div class="playlist-item">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 genres">
					<div class="playlist-item">
						...
						<h5><a href="bollywood.php">Bollywood</h5>
					</div>
				</div>
				<!-- <div class="mix col-lg-3 col-md-4 col-sm-6 artists">
					<div class="playlist-item">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 movies">
					<div class="playlist-item">
						...
						<h5><a href="EnglishPop.php">English Pop</h5>
					</div>
				</div>
				<div class="mix col-lg-3 col-md-4 col-sm-6 labels">
					<div class="playlist-item">
						<img src="img/playlist/12.jpg" alt="">
						<h5><a href="EnglishPop.php">The 90’s</h5>
					</div>
				</div>
				<!-- <div class="mix col-lg-3 col-md-4 col-sm-6 genres">
					<div class="playlist-item">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 movies">
					<div class="playlist-item">
						...
						<h5><a href="hiphop.php">Hiphop</h5>
					</div>
				</div>
			</div>
		</div>
