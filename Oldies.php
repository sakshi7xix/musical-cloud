...
<body>
  ...
  <!-- <p>
    ...
    <h1> Audio sample </h1>
  <audio controls>
    <source src="oldies/udejabterisulfe.mp3" type="audio/mpeg">
    Your browser does not support the audio element.  
  </audio>

  <audio controls>
    <source src="oldies/Kajra Mohabbat Wala - Kismat.mp3" type="audio/mpeg">
    Your browser does not support the audio element.  
  </audio>
  </p> -->

  <p>	
		<h1> Bollywood Oldies </h1>
		<table>
			<thead>
				<tr>
					<th>No.</th>
          ...
          <th>Player</th>
			...
			<tbody>
				 <?php
				  $selectquery2 = "SELECT * FROM oldies";
